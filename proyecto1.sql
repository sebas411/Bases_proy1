...
create table cancion(id serial primary key, artista_id int, nombre varchar(30), genero_id int references genero(id), link varchar(50), foreign key(artista_id) references artista(id), activo boolean default true);
create table genero (id serial primary key, nombre text)
